// AnomalyAlert.tsx - 기존 S3 API를 사용한 프론트엔드 전용 이상치 감지
...
const DEFAULT_THRESHOLDS: ThresholdSettings = {
  temperature: {
    warningMin: 10.0,   // 10도 이하 경고
    warningMax: 30.0,   // 30도 이상 경고
    dangerMin: 5.0,     // 5도 이하 위험
    dangerMax: 35.0,    // 35도 이상 위험
  },
  humidity: {
    warningMin: 30.0,   // 30% 이하 경고
    warningMax: 80.0,   // 80% 이상 경고
    dangerMin: 20.0,    // 20% 이하 위험
    dangerMax: 90.0,    // 90% 이상 위험
  },
  gas: {
    warningMax: 1000.0, // 1000ppm 이상 경고
    dangerMax: 1500.0,  // 1500ppm 이상 위험
  },
};
